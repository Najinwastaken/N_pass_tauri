...
| Файл | Что это |
| --- | --- |
| `N-Pass_x.y.z_x64-setup.exe` | Установщик (рекомендуется) — ставится в папку пользователя, права администратора не нужны |
| `n-pass.exe` | Портативная версия — положите в любую папку и запускайте |
| `N-Pass_x.y.z_x64_en-US.msi` | MSI-установщик — **не рекомендуется**: ставит в Program Files, где портативное хранилище работать не сможет |
