...
const DICT = {
  ...
  fCategory: ["Category", "Категория", "Категорія"],
  categoryPh: ["e.g. Mail, Games", "например, Почта, Игры", "наприклад, Пошта, Ігри"],
  filterAll: ["All", "Все", "Усі"],
  categoryOther: ["Other", "Прочее", "Інше"],
  ...
  vaultMergedToast: [
    "This vault was changed elsewhere. {n} change(s) from that copy were merged in.",
    "Хранилище изменили в другом месте. Из той копии перенесено изменений: {n}.",
    "Сховище змінили в іншому місці. З тієї копії перенесено змін: {n}.",
  ],
  version: ["Version", "Версия", "Версія"],
